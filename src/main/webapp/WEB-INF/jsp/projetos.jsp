...
<table class="table table-striped table-hover">
   ...
   <div class="modal fade" id="modalExcluir" tabindex="-1" aria-labelledby="modalExcluir" aria-hidden="true">
    ...
    async function excluirProjeto(id){
        ...
        if(mensagemErro){
            let mensagemErroModal = modalErro.querySelector('.modal-body');
            mensagemErroModal.textContent = mensagemErro;

            let modalErroInstance = bootstrap.Modal.getInstance(modalErro);
